namespace Ecommerce.UserControls
{
    partial class ProductStockStatus
    {
        ...
        private void InitializeComponent()
        {
            ...
            // panel4
            // 
            panel4.Controls.Add(PopProductFilter);
            ...
            // PopProductFilter
            // 
            PopProductFilter.Dock = DockStyle.Fill;
            PopProductFilter.Font = new Font("Segoe UI", 11F);
            PopProductFilter.FormattingEnabled = true;
            PopProductFilter.Items.AddRange(new object[] { "ALL", "5", "10", "15", "20", "25", "30 " });
            PopProductFilter.Location = new Point(5, 1);
            PopProductFilter.Name = "PopProductFilter";
            PopProductFilter.Size = new Size(127, 28);
            PopProductFilter.TabIndex = 9;
            PopProductFilter.SelectedIndexChanged += PopProductFilter_SelectedIndexChanged;
            // 
            // ProductStockStatus
            // 
        ...
        private ComboBox PopProductFilter;
